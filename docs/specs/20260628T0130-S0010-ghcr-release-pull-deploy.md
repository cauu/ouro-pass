...
- TC-1..TC-6 | stack: go/docker/shell | command: p5-1 汇总 | result: pass | note: go build/vet 绿、子命令一致、buildx amd64+arm64 OK、actionlint OK、compose config OK、交付物齐备、无新依赖
